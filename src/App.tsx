    ...
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="markers-section section-frame content-section" id="marker">
          <div className="marker-header"><div><div className="section-kicker">/ 02 — KOLEKSI MARKER</div><h2>Rambu dalam<br /><em>genggamanmu.</em></h2></div><p>Scan koleksi marker menggunakan kamera AR pada aplikasi dan temukan informasi di balik setiap rambu. Klik untuk preview.</p></div>
